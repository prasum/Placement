      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1" >
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="#">Demos &amp; Projects <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="http://www.thesoftwareguy.in/working-demos/">Demos</a></li>
                <li><a href="http://www.thesoftwareguy.in/mini-project/">Projects</a></li>
              </ul>
